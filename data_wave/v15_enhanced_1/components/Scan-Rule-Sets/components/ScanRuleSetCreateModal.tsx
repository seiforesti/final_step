...
type CreateRuleSetFormData = z.infer<typeof createRuleSetSchema>
...
export const ScanRuleSetCreateModal: React.FC<ScanRuleSetCreateModalProps> = ({
  open,
  onOpenChange,
  onSubmit,
  isLoading = false,
  ...
  const handleFormSubmit = useCallback(
    async (data: CreateRuleSetFormData) => {
      try {
        await onSubmit(data)
        reset()
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Create New Scan Rule Set</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={(value) => setValue("type", value as "system" | "custom")}>
                        <SelectTrigger>
                  ...
                  {watchedValues.schedule?.enabled && (
                    <div className="space-y-4 pl-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select onValueChange={(value) => setValue("schedule.timezone", value)}>
                          <SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? <LoadingSpinner size="sm" variant="inline" message="Creating..." /> : "Create Rule Set"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
