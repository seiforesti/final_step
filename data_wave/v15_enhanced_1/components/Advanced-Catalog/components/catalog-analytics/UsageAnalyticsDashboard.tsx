...
import { TrendingUp, TrendingDown, Eye, EyeOff, Activity, Users, Database, Clock, Calendar as CalendarIcon, Download, Upload, Search, Filter, Settings, RefreshCw, Share, Bell, AlertTriangle, CheckCircle, XCircle, Info, MoreHorizontal, Plus, Minus, ArrowUp, ArrowDown, ArrowRight, ArrowLeft, ChevronUp, ChevronDown, ChevronRight, ChevronLeft, Play, Pause, Square, SkipForward, SkipBack, Volume2, VolumeX, Maximize, Minimize, Copy, ExternalLink, Edit, Trash, Save, Star, StarOff, Heart, Bookmark, BookmarkX, MessageSquare, Mail, Phone, User, Users2, Building, Globe, MapPin, Tag, Hash, AtSign, Link, Image, FileText, File, Folder, FolderOpen, Archive, Package, Box, Grid, List, Layout, Sidebar, PanelLeft, PanelRight, Monitor, Smartphone, Tablet, Laptop, Watch, Gamepad2, Headphones, Speaker, Mic, Camera, Video, Music, Radio, Tv, Wifi, WifiOff, Bluetooth, BluetoothOff, Battery, BatteryLow, Power, PowerOff, Zap, ZapOff, Sun, Moon, Cloud, CloudRain, CloudSnow, Umbrella, Wind, Thermometer, Droplets, Mountain, Tree, Flower, Leaf, Seedling, Bug, Bird, Fish } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <div className="space-y-2">
                {[
                  { path: 'Home → Search → Asset Details → ArrowDownTrayIcon', users: 1234, conversion: 85 },
