...
import { TrendingUp, TrendingDown, BarChart3, LineChart, PieChart, Activity, AlertTriangle, CheckCircle, XCircle, Clock, Filter, Download, RefreshCw, Calendar as CalendarIcon, Settings, Eye, EyeOff, Maximize2, Minimize2, Play, Pause, RotateCcw, Zap, Target, Brain, Lightbulb, Shield, Layers, ArrowUpRight, ArrowDownRight, ArrowRight, Search, Plus, Minus, X, Info, HelpCircle, ExternalLink, Save, Share2, Copy, Edit, Trash2, Archive, Star, Flag, Tag, BookOpen, Database, Server, Globe, Users, UserCheck, Mail, Bell, Smartphone, Monitor, Cpu, MemoryStick, HardDrive, Network, Wifi, Cloud, CloudOff, Lock, Unlock, Key, Fingerprint, Gauge, Thermometer, Timer, Stopwatch, Battery, BatteryLow, Fuel, Anchor, Compass, Map, Navigation, Route, MapPin, Radar as RadarIcon, Satellite, Radio, Mic, Volume2, VolumeX, Headphones, Speaker, Gamepad2, Joystick, Mouse, Keyboard, Printer, Scanner, Camera, Video, Image, Film, Music, Disc, Cassette, Radio as RadioIcon } from 'lucide-react';
