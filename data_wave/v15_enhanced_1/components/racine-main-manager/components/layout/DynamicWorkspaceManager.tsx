...
import { Layout, Grid3X3, Move, RotateCcw, RotateCw, Copy, Trash2, Plus, Minus, ZoomIn, ZoomOut, Maximize2, Minimize2, Settings, Save, Upload, Download, Share2, Users, Lock, Unlock, Eye, EyeOff, Layers, Target, Crosshair, MousePointer, Hand, Grab, GrabIcon, Palette, Brush, Wand2, Sparkles, Brain, Zap, Activity, BarChart3, TrendingUp, Clock, History, RefreshCw, AlertTriangle, CheckCircle, Info, HelpCircle, Search, Filter, SortAsc, MoreHorizontal, ChevronLeft, ChevronRight, ChevronUp, ChevronDown } from 'lucide-react';
