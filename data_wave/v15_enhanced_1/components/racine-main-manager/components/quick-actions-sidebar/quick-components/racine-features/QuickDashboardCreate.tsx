...
// Icons
import { BarChart3, PieChart, LineChart, Activity, TrendingUp, TrendingDown, Gauge, Target, Zap, Database, Users, Calendar, Clock, AlertTriangle, CheckCircle, XCircle, Info, Plus, Minus, X, Copy, Share, Download, Upload, Save, Edit, Eye, EyeOff, Settings, MoreHorizontal, Grid, Layout, Maximize, Minimize, RotateCcw, RefreshCw, Filter, Search, SortAsc, SortDesc, ArrowUp, ArrowDown, ArrowLeft, ArrowRight, Move, Resize, Square, Circle, Triangle, Diamond, Heart, Star, Hexagon, Octagon, Pentagon, Sparkles, Wand2, Brain, Cpu, HardDrive, Network, Shield, Lock, Unlock, Key, Globe, Map, MapPin, Navigation, Radar, Scan, Monitor, Tablet, Smartphone, Laptop, Server, Cloud, CloudRain, Sun, Moon, Sunrise, Sunset, Wind, Snowflake, Droplets, Thermometer, Battery, Wifi, Bluetooth, Volume2, VolumeX, Mic, MicOff, Camera, Video, FileText as FileTextIcon, File as FileIcon, Image as ImageIcon, FileText, Folder, FolderOpen, Archive, Package, Layers, Component, Boxes, Building, Home, Factory, Store, Briefcase, Wallet, CreditCard, DollarSign, Euro, PoundSterling, Yen, Bitcoin, TrendingUpDown, BarChart, BarChart2, BarChart4, ScatterChart, Table, Table2, Columns, Rows, Grid2X2, Grid3X3, LayoutGrid, LayoutList, LayoutDashboard, PanelLeftOpen, PanelRightOpen, PanelTopOpen, PanelBottomOpen, SplitSquareHorizontal, SplitSquareVertical, MousePointer, MousePointer2, Hand, Grab, GrabIcon, Crosshair, Focus, Aperture, Disc, Play, Pause, SkipBack, SkipForward, FastForward, Rewind, Repeat, Shuffle, RotateCw, FlipHorizontal, FlipVertical, ZoomIn, ZoomOut, Fullscreen, Minimize2, Maximize2, PictureInPicture, PictureInPicture2, ScreenShare, ScreenShareOff, CastIcon, AirplayIcon, BluetoothConnected, Radio, Signal, SignalHigh, SignalLow, SignalMedium, SignalZero, Antenna, Broadcast, Podcast, Rss, Satellite, SatelliteDish, Router, Ethernet, Cable, Usb, UsbIcon, HardDriveDownload, HardDriveUpload, Download as DownloadIcon, Upload as UploadIcon, Import, Export, Send, SendHorizonal, Mail, MailOpen, MessageSquare, MessageCircle, PhoneCall, Phone, PhoneIncoming, PhoneOutgoing, PhoneMissed, Voicemail, Contact, Contact2, UserCheck, UserPlus, UserMinus, UserX, UserCog, UserSearch, UsersRound, UserRound, UserRoundCheck, UserRoundCog, UserRoundMinus, UserRoundPlus, UserRoundSearch, UserRoundX, Crown, Award, Trophy, Medal, Ribbon, Gift, PartyPopper, Cake, Coffee, Pizza, Apple, Beef, Carrot, Cherry, Cookie, Croissant, Egg, Fish as FishIcon, Grape, IceCream, Lemon, Milk, Nut, Sandwich, Soup, Wheat, Wine, Utensils, UtensilsCrossed, ChefHat, CookingPot, Refrigerator, Microwave, Oven, Blender, Scale, Timer, Hourglass, Stopwatch, Watch, AlarmClock, Calendar as CalendarIcon, CalendarCheck, CalendarClock, CalendarDays, CalendarHeart, CalendarMinus, CalendarPlus, CalendarRange, CalendarSearch, CalendarX, Clock1, Clock2, Clock3, Clock4, Clock5, Clock6, Clock7, Clock8, Clock9, Clock10, Clock11, Clock12,  } from 'lucide-react';
                ...
                <div className="flex items-center justify-between p-2 border-b bg-muted/30">
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      ...
                      {isDragMode ? 'Square Drag' : 'Drag Mode'}
                    </Button>
