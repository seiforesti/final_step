...
import { Activity, BarChart3, Bell, BrainCircuit, Camera, CheckCircle, ChevronDown, ChevronRight, Clock, Database, Download, Eye, FileText, Filter, GitBranch, LineChart as LucideLineChart, Loader2, MoreHorizontal, Pause, Play, Plus, RefreshCw, Settings, Shield, TrendingDown, TrendingUp, X, Zap, Gauge, MapPin, Target, Timer, Workflow, BarChart4, Layers, Search, Calendar, Archive, Trash2, Edit3, Copy, ExternalLink, Mail, Smartphone, Slack, AlertCircle, Info, AlertTriangle, ShieldAlert, Rocket, Lightbulb, Binary, Code2, Monitor, HelpCircle, Star, Users, Lock, Unlock, RotateCcw, FastForward, StopCircle, Sparkles, Flame, Award, Share2, Save, Maximize2, Minimize2, TrendingUp as TrendUp, TrendingDown as TrendDown,  } from 'lucide-react';
import {
