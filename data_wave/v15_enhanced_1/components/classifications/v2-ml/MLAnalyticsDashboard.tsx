...
import { BarChart3, TrendingUp, TrendingDown, Activity, Target, Brain, Zap, Clock, DollarSign, Users, Database, Cpu, MemoryStick, HardDrive, Network, Eye, EyeOff, Filter, Search, Download, Upload, RefreshCw, AlertTriangle, CheckCircle, AlertCircle, Info, Settings, Calendar, MapPin, Globe, Smartphone, Monitor, Tablet, Layers, GitBranch, Gauge, PieChart as PieChartIcon, LineChart as LineChartIcon, BarChart2, Sparkles, Award, Bookmark, Star, ThumbsUp, ThumbsDown, ArrowUp, ArrowDown, ArrowRight, Plus, Minus, X, Edit, Trash2, Copy, Save, FileText, Code, Play, Pause, Square, SkipForward, SkipBack, Volume2, VolumeX, Maximize, Minimize, RotateCcw, RotateCw, ZoomIn, ZoomOut,  } from 'lucide-react';
