...
import { Users, Plus, Minus, Edit, Trash2, Save, Share, Link, Copy, Download, Upload, RefreshCw, Settings, Search, Filter, Eye, EyeOff, Play, Pause, Square, Clock, Calendar, User, MessageSquare, Bell, BellOff, Mail, Phone, Video, FileText, Code, Database, Activity, Target, Zap, Brain, GitBranch, Layers, Network, Shuffle, ArrowRight, ArrowDown, ArrowUp, ChevronRight, ChevronDown, ChevronLeft, ChevronUp, MoreHorizontal, MoreVertical, Info, HelpCircle, AlertTriangle, CheckCircle, XCircle, Star, Bookmark, Flag, Tag, Maximize, Minimize, ExternalLink, Send, Paperclip, Smile, ThumbsUp, ThumbsDown, Heart, Coffee, Lightbulb } from 'lucide-react';
