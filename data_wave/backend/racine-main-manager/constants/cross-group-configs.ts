...
// ============================================================================
// SEARCH CONFIGURATIONS (added for GlobalSearchInterface)
// ============================================================================

import type { SearchFilters } from '../types/racine-core.types';

export const SEARCH_DEBOUNCE_DELAY = 300;
export const MAX_SEARCH_RESULTS = 100;

export const SUPPORTED_SEARCH_TYPES = [
  'asset',
  'rule',
  'policy',
  'workflow',
...
export const SEARCH_CONFIGS = {
  ...
  supportedTypes: SUPPORTED_SEARCH_TYPES,
} as const;
