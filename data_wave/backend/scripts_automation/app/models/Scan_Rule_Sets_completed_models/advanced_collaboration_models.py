...
class RuleComment(SQLModel, table=True):
    ...
    # Comment Hierarchy
    parent_comment_id: Optional[int] = Field(default=None, foreign_key="rule_comments.id")
    ...
    parent_comment: Optional["RuleComment"] = Relationship(
        back_populates="child_comments",
        sa_relationship_kwargs={"remote_side": "RuleComment.id"}
    )
