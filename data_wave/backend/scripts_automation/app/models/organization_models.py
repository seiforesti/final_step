...
class Organization(SQLModel, table=True):
    ...
    trend_analyses: List["TrendAnalysis"] = Relationship(back_populates="organization")
    roi_metrics: List["ROIMetrics"] = Relationship(back_populates="organization")
    compliance_integrations: List["ComplianceIntegration"] = Relationship(back_populates="organization")
...
if TYPE_CHECKING:
    ...
    from .Scan_Rule_Sets_completed_models.analytics_reporting_models import (
        ...
        ComplianceIntegration, MarketplaceAnalytics, UsageMetrics
    )
