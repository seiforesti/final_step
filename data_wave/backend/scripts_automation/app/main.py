...
async def metrics():
    ...
    metrics_data = f"""# HELP data_governance_platform_info Information about the data governance platform
# TYPE data_governance_platform_info gauge
data_governance_platform_info{{version="2.0.0",platform="PurSight Enterprise Data Governance"}} 1

# HELP data_governance_health_status Current health status
# TYPE data_governance_health_status gauge
data_governance_health_status 1
