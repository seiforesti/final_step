...
class AdvancedPatternMatchingService:
    def __init__(self):
        ...
        # Defer service initialization to prevent startup failures
        self.base_pattern_service = None
        self.rule_optimizer = None
        self.scan_intelligence_service = None
        ...
        logger.info("Advanced Pattern Matching Service initialized (services deferred)")
    ...
    def start(self) -> None:
        ...
        try:
            ...
            if not self._services_initialized:
                ...
                logger.info("Advanced Pattern Matching Service services initialized")
    ...
    def _ensure_services_ready(self):
        ...
        if not self._services_initialized:
            ...
            self.catalog_service = EnterpriseCatalogService()
            self._services_initialized = True
            logger.info("Advanced Pattern Matching Service services initialized on-demand")
