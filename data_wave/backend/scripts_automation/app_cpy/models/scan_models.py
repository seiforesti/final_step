...
class DataSource(SQLModel, table=True):
    ...
    # **INTERCONNECTED: Organization Management**
    organization: Optional["Organization"] = Relationship(back_populates="data_sources")
...
class ScanOrchestrationJob(SQLModel, table=True):
    ...
    organization: Optional["Organization"] = Relationship(back_populates="scan_orchestration_jobs")
