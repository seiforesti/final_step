...
import { GitBranch, GitCommit, GitMerge, History, RotateCcw, Tag, Users, User, Calendar, Clock, Edit, Save, Copy, Download, Upload, Share2, GitCompare, Eye, EyeOff, Plus, Minus, X, Check, CheckCircle, XCircle, AlertTriangle, Info, HelpCircle, Settings, Filter, Search, SortAsc, SortDesc, ChevronDown, ChevronRight, ChevronUp, MoreHorizontal, RefreshCw, Loader2, ArrowRight, ArrowLeft, ArrowUp, ArrowDown, Scissors, Link, Unlink, Split, Merge, File, FileText, Folder, FolderOpen, Archive, Bookmark, Star, Heart, ThumbsUp, ThumbsDown, MessageSquare, Bell, BellOff, Lock, Unlock, Shield, Globe, Workflow, Activity, TrendingUp, BarChart3, PieChart, Target, Zap, Code, Database, Server, Cloud, Cpu, HardDrive, Signal, Wifi, Bluetooth, Radio, Phone, Mail, Send, Inbox, Trash2, Package, Box, Archive as ArchiveIcon, FileArchive, FolderArchive, Package2, PackageCheck, PackageOpen, PackageX, Layers, Grid, List, Table, Columns, Rows, Layout, LayoutGrid, LayoutList, Sidebar, PanelLeft, PanelRight, PanelTop, PanelBottom, Maximize, Minimize, SquareStack, Boxes } from 'lucide-react';
