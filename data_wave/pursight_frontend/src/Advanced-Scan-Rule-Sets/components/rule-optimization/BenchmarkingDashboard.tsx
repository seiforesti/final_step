...
import { Target, BarChart3, TrendingUp, TrendingDown, Award, Trophy, Medal, Crown, Star, ChevronUp, ChevronDown, Activity, Zap, Clock, Cpu, Database, Network, HardDrive, AlertTriangle, CheckCircle, XCircle, Timer, Gauge, Filter, Search, RefreshCw, Download, Upload, Settings, Eye, EyeOff, Play, Pause, RotateCcw, Calendar, MapPin, Layers, GitBranch, Users, Share, FileText, MoreHorizontal, ChevronRight, Info, Lightbulb, Sparkles, LineChart, PieChart, BarChart2, Radar, Flame, Snowflake, Wind, Sun, CloudRain, ShieldCheckIcon, Rocket, Bell, Hash, Percent, ArrowRight, ArrowLeft, Plus, Minus, Edit, Trash2, Copy, ExternalLink, Globe, Building, Briefcase,  } from 'lucide-react';
import {
