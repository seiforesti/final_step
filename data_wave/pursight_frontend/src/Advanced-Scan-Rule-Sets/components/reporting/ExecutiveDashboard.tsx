...
import { Calendar, TrendingUp, TrendingDown, Activity, Target, DollarSign, Users, Clock, AlertTriangle, CheckCircle2, XCircle, BarChart3, LineChart, PieChart, Filter, Download, RefreshCcw, Settings, Eye, EyeOff, Maximize2, Minimize2, Search, Bell, Info, Zap, Shield, Database, Globe, Cpu, MemoryStick, HardDrive, Network, Gauge, ArrowUp, ArrowDown, ArrowRight, ChevronUp, ChevronDown, ChevronRight, PlayCircle, PauseCircle, StopCircle, FastForward, Rewind, SkipForward, SkipBack, RotateCcw, RotateCw, Layers, Grid, List, Table, Card as CardIcon, Map, Share2, Link2, Copy, ExternalLink, Bookmark, Star, Heart, ThumbsUp, MessageSquare, Send, Mail, Phone, MapPin, Calendar as CalendarIcon, Clock as ClockIcon, User, Building, Briefcase, Award, Medal, Trophy, Crown, Gem, Sparkles, Flame, Zap as ZapIcon, Lightning, Sun, Moon, Cloud, CloudRain, Snowflake, Wind, Thermometer, Umbrella, Rainbow, Sunrise, Sunset } from 'lucide-react'
...
import { Table as UITable, TableBody as UITableBody, TableCaption as UITableCaption, TableCell as UITableCell, TableHead as UITableHead, TableHeader as UITableHeader, TableRow as UITableRow } from '@/components/ui/table'
