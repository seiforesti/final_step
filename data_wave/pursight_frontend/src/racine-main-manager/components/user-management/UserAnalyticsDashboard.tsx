...
// Icons
import { BarChart3, LineChart, PieChart, TrendingUp, TrendingDown, Activity, Users, User, UserCheck, UserX, UserPlus, UserMinus, Eye, EyeOff, MousePointer, MousePointer2, Clock, Timer, Calendar as CalendarIcon, Target, Zap, Award, Star, StarOff, Heart, ThumbsUp, ThumbsDown, MessageSquare, MessageCircle, Share2, Share, Download, Upload, RefreshCw, Filter, Search, SortAsc, SortDesc, MoreHorizontal, Settings, Info, AlertCircle, AlertTriangle, CheckCircle, XCircle, Plus, Minus, X, Check, ArrowUp, ArrowDown, ArrowLeft, ArrowRight, ArrowUpDown, ChevronDown, ChevronRight, ChevronLeft, ChevronUp, Loader2, MapPin, Globe, Monitor, Smartphone, Tablet, Laptop, Watch, Gamepad2, Headphones, Camera, Mic, Speaker, Wifi, WifiOff, Signal, Battery, Power, Bluetooth, Database, Server, Cloud, HardDrive, Cpu, Network, FileText, Folder, FolderOpen, Archive, History, BookOpen, Book, Bookmark, Tag, Hash, AtSign, Link, ExternalLink, Mail, Phone, Building, Home, Navigation, Compass, Map, Route, Flag, Bell, BellOff, Volume2, VolumeOff, Play, Pause, Square, SkipForward, SkipBack, FastForward, Rewind, Repeat, Shuffle, Radio, Rss, Wifi as WifiIcon, Bluetooth as BluetoothIcon, Battery as BatteryIcon, Signal as SignalIcon } from 'lucide-react';
...
export const UserAnalyticsDashboard: React.FC<UserAnalyticsDashboardProps> = ({
  ...
  useEffect(() => {
    ...
    const connectWebSocket = () => {
      const ws = new WebSocket(`${(typeof window !== 'undefined' && (window as any).ENV?.NEXT_PUBLIC_WS_URL)}/user-analytics`);
