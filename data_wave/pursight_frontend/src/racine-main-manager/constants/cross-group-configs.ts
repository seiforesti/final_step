...
export const FEATURE_FLAGS = {
  BETA_FEATURES: (typeof window !== 'undefined' && (window as any).ENV?.NEXT_PUBLIC_ENABLE_BETA) === 'true',
  DEBUG_MODE: (typeof window !== 'undefined' && (window as any).ENV?.NODE_ENV) === 'development',
  ANALYTICS: (typeof window !== 'undefined' && (window as any).ENV?.NEXT_PUBLIC_ENABLE_ANALYTICS) === 'true',
