...
import { BarChart3, TrendingUp, Activity, DollarSign, Users, Target, Award, Clock, Database, Monitor, Cpu, AlertTriangle, CheckCircle, XCircle, Info, Settings, Search, Filter, Download, Upload, RefreshCw, Play, Pause, MoreVertical, Eye, Edit, Trash2, Plus, Minus, ArrowUp, ArrowDown, ArrowRight, Calendar, Globe, Shield, Lock, Unlock, Star, Heart, Bookmark, Share, MessageSquare, Bell, Mail, Phone, Video, Mic, Camera, Image, File, Folder, Archive, Tag, Flag, Map, Navigation, Compass, Route, Layers, Grid, List, Table, Kanban, PieChart as PieChartIcon, LineChart as LineChartIcon, Building, Briefcase, Calculator, CreditCard, FileText, Presentation, Lightbulb, Zap, Brain, Network, Bot, Workflow, GitBranch, Boxes, Package, Server, Cloud, HardDrive, Wifi, Bluetooth, Smartphone, Laptop, Tablet, Watch, Headphones, Speaker, Gamepad2, Joystick, Home, Car, Plane, Train, Ship, Truck, Bike, Bus, Satellite, Radar, Microscope, Atom, Dna, Fingerprint, QrCode, Barcode, ScanLine, CameraOff, Volume2, VolumeX, Maximize, Minimize, RotateCcw, RotateCw, FlipHorizontal, FlipVertical, Copy, Scissors, PaintBucket, Palette, Brush, Pen, PenTool, Eraser, Ruler, Move, MousePointer, Hand, GripHorizontal, GripVertical, CornerDownLeft, CornerDownRight, CornerUpLeft, CornerUpRight, ChevronDown, ChevronUp, ChevronLeft, ChevronRight, ChevronsDown, ChevronsUp, ChevronsLeft, ChevronsRight, Menu, X, Hash, AtSign, Percent, Ampersand, Quote, Italic, Bold, Underline, Strikethrough, AlignLeft, AlignCenter, AlignRight, AlignJustify, Indent, Outdent, WrapText, Type, Code, Code2, Terminal, Command as CommandIcon, Circle, Square, Triangle, Diamond, Pentagon, Hexagon, Octagon, Star as StarIcon, Heart as HeartIcon, Smile, Frown, Meh, ThumbsUp, ThumbsDown, TrendingDown, Minus as MinusIcon, Equal, MoreHorizontal, MoreVertical as MoreVerticalIcon, CheckSquare, XSquare, MinusSquare, PlusSquare, PlaySquare, PauseOctagon, StopCircle, SkipBack, SkipForward, Rewind, FastForward, Repeat, Repeat1, Shuffle, Volume, Volume1, Mic2, MicOff, Radio, Disc, Disc2, Disc3, Music, Music2, Music3, Music4, Headphones as HeadphonesIcon, Airplay, Cast, Tv, Tv2, Radio as RadioIcon, Podcast, Rss, Wifi as WifiIcon, WifiOff, Signal, SignalHigh, SignalLow, SignalMedium, SignalZero, Antenna, Bluetooth as BluetoothIcon, BluetoothConnected, BluetoothOff, BluetoothSearching, Nfc, Usb, HardDrive as HardDriveIcon, ScanEye, ScanFace, ScanSearch, ScanText, Scan, QrCode as QrCodeIcon, Barcode as BarcodeIcon, ScanLine as ScanLineIcon, Fingerprint as FingerPrintIcon, ShieldCheckIcon, ShieldAlert, ShieldClose, ShieldEllipsis, ShieldMinus, ShieldOff, ShieldPlus, ShieldQuestion, ShieldX, Lock as LockIcon, LockKeyhole, Unlock as UnlockIcon, Key, KeyRound, KeySquare, Banknote, Coins, CreditCard as CreditCardIcon, Wallet, Receipt, PiggyBank, TrendingUp as TrendingUpIcon, TrendingDown as TrendingDownIcon } from 'lucide-react';
...
const QUICK_ACTIONS = [
  ...
  { id: 'export-results', name: 'Export Results', icon: ArrowDownTrayIcon, shortcut: 'Ctrl+E' },
