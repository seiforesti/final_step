...
import { MessageSquare, Bot, User, Send, Mic, MicOff, Volume2, VolumeX, Settings, Search, Filter, Download, Upload, Share2, Copy, Save, RefreshCw, Play, Pause, Square, SkipForward, SkipBack, Plus, Minus, Edit, Trash2, MoreHorizontal, Eye, EyeOff, Brain, Zap, Activity, TrendingUp, BarChart3, Network, Database, Server, Cloud, Globe, Lock, Unlock, Shield, Key, Users, Calendar, Clock, MapPin, Flag, Star, Heart, Bookmark, MessageCircle, Mail, Phone, Link, ExternalLink, ArrowRight, ArrowLeft, ChevronRight, ChevronLeft, ChevronUp, ChevronDown, Image, FileText, File, Video, Music, Camera, Headphones, Speaker, Monitor, Smartphone, Tablet, Laptop, Wifi, Bluetooth, Lightbulb, Target, Award, Trophy, Gift, Sparkles, Flame, Droplets, Wind, Sun, Moon, Stars, Thermometer, Cpu, MemoryStick, HardDrive, Layers, Grid, List, Table, GitBranch, TreePine, Workflow, FlowChart, Info, AlertTriangle, CheckCircle, XCircle, HelpCircle, Maximize, Minimize, ZoomIn, ZoomOut, RotateCcw, Hash, AtSign, Percent,  } from 'lucide-react';
