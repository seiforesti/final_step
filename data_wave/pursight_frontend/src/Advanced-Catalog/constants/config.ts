...
export const API_CONFIG = {
  BASE_URL: (typeof window !== 'undefined' && (window as any).ENV?.NEXT_PUBLIC_API_BASE_URL) || 'http://localhost:3000/proxy',
...
export const ENVIRONMENT_CONFIG = {
  NODE_ENV: (typeof window !== 'undefined' && (window as any).ENV?.NODE_ENV) || 'development',
  IS_PRODUCTION: (typeof window !== 'undefined' && (window as any).ENV?.NODE_ENV) === 'production',
  IS_DEVELOPMENT: (typeof window !== 'undefined' && (window as any).ENV?.NODE_ENV) === 'development',
  IS_TEST: (typeof window !== 'undefined' && (window as any).ENV?.NODE_ENV) === 'test',
  
  // Logging
  LOG_LEVEL: (typeof window !== 'undefined' && (window as any).ENV?.LOG_LEVEL) || 'info',
  ENABLE_DEBUG_LOGS: (typeof window !== 'undefined' && (window as any).ENV?.NODE_ENV) !== 'production',
  LOG_TO_CONSOLE: true,
  LOG_TO_FILE: false,
  
  // Monitoring
  SENTRY_ENABLED: (typeof window !== 'undefined' && (window as any).ENV?.SENTRY_DSN) ? true : false,
  ANALYTICS_ENABLED: (typeof window !== 'undefined' && (window as any).ENV?.ANALYTICS_ID) ? true : false,
