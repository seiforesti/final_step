...
const NaturalLanguageQuery: React.FC = () => {
  ...
  const setupRealTimeUpdates = useCallback(() => {
    ...
    const ws = new WebSocket((typeof window !== 'undefined' && (window as any).ENV?.NEXT_PUBLIC_WS_URL) || 'ws://localhost:8000/ws/nlq');
