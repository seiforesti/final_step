...
\author{Seif Oresti}
%%% if necessary - Set isBinomal to true for two authors
...
% \setboolean{isBinomal}{true}
% \secondAuthor{Prénom NOM du binôme}
...
%% Entreprise d'accueil
\companyName{Nom de l'Entreprise d'Accueil}
...
\companyFax{+216 XX XXX XXX}
\companyAddressAR{العنوان بالعربية - المدينة - تونس}
\companyAddressFR{Adresse de l'entreprise, Ville, Code Postal, Tunisie}
